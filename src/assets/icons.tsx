...
export function MoviesIcon({ className }: { className?: string }) {
  return (
    <svg
      width="12"
      height="12"
...
export function SeriesIcon({ className }: { className?: string }) {
  return (
    <svg
      width="12"
      height="12"
...
export function BookmarkFull({ className }: { className?: string }) {
  return (
    <svg
      width="12"
      height="14"
